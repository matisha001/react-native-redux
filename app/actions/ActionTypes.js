...
export const FETCH_ARTICLE_LIST = 'FETCH_ARTICLE_LIST';//加载数据列表
export const RECEIVE_ARTICLE_LIST = 'RECEIVE_ARTICLE_LIST';//接收数据列表
export const FETCH_TYPE_LIST = 'FETCH_TYPE_LIST';//数据列表类型
export const RECEIVE_TYPE_LIST = 'RECEIVE_TYPE_LIST';//获取数据列表类型
export const RECEIVE_ARTICLE_LIST_MORE = 'RECEIVE_ARTICLE_LIST_MORE';//获取更多文章列表

export const RECEIVE_BEAUTY_LIST = 'RECEIVE_BEAUTY_LIST';//获取更多图片列表
